...
# Version: 3.1 (verbatim upstream, MIT License)
#
# NOT wired into any aria2 hook by default. To enable, point on-download-complete
# in aria2.conf at this script instead of clean.sh, install rclone, and configure
# a remote with `rclone config` first.
#
